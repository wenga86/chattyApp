...
let me: User = new User('Juliet', "img/male-avatar-3.png");
let ladycap: User = new User('Lady Capulet', "img/male-avatar-3.png");
let echo: User = new User('Echo Bot', "img/male-avatar-3.png");
let rev: User = new User('Reverse Bot', "img/male-avatar-3.png");
let wait: User = new User('Waiting Bot', "img/male-avatar-3.png");
